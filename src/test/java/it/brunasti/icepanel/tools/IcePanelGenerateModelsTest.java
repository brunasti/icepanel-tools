...
class IcePanelGenerateModelsTest implements TestConstants {
//
...
//  }
  ...
  @Test
  @DisplayName("Call IcePanelToolsMain main to generate models")
  void testGenerate_Models() {
    String[] args = new String[6];

    System.err.println("testGenerate_Models ------ Anonym -----");

    args[0] = "examples/anonym/Document Anonymizer (Current).json";
    args[1] = "examples/anonym/DocumentAnonymizer.puml";
    args[2] = "-d";
    args[3] = "10";
    args[4] = "-c";
    ...
    System.err.println("testGenerate_Models ------ BA -----");
    ...
    System.err.println("testGenerate_Models ------ PG -----");
    args[0] = PG_JSON;
    args[1] = PG_OUT;
    args[2] = "-d";
    args[3] = "10";
    ...
    System.err.println("testGenerate_Models ------ SG -----");
    args[0] = SG_JSON;
    args[1] = SG_OUT;
    args[2] = "-d";
    args[3] = "10";
    ...
    System.err.println("testGenerate_Models ------ ML -----");
    args[0] = ML_JSON;
    args[1] = ML_OUT;
    args[2] = "-d";
    args[3] = "10";
    ...
    System.err.println("testGenerate_Models ------ AI -----");
    args[0] = AI_JSON;
    args[1] = AI_OUT;
    args[2] = "-d";
    args[3] = "10";
