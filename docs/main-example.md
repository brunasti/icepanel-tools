# Example of a full IcePanel project converted to PlantUML

## C4 Level 0 : All the elements
![C4 - 0 All elements](./images/output.png)
...
![IcePanel Flows](./images/icePanel-C4-output-Flow-Transfer data to OpenSearch by Control-M Batch Flow.png)
